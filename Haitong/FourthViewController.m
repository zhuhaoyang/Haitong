...
- (void)hide:(id)sender
{
    ...
    if (btHide.tag == 1) {
        ...
        [btHide setBackgroundImage:[UIImage imageNamed:@"life_one_03"] forState:UIControlStateNormal];
        ...
        [btHide setBackgroundImage:[UIImage imageNamed:@"hide"] forState:UIControlStateNormal];
...
//    [self.navigationController setNavigationBarHidden:YES animated:YES];
    ...
    [bt1 setBackgroundImage:[UIImage imageNamed:@"little_02"] forState:UIControlStateNormal];
    ...
    [bt2 setBackgroundImage:[UIImage imageNamed:@"little_03"] forState:UIControlStateNormal];
    ...
    [bt3 setBackgroundImage:[UIImage imageNamed:@"little_04"] forState:UIControlStateNormal];
    ...
    [bt4 setBackgroundImage:[UIImage imageNamed:@"little_05"] forState:UIControlStateNormal];
    ...
    imgBack = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"new_02"]];
    imgBack.frame = CGRectMake(0, 768, 1024, 519);
    [self.view addSubview:imgBack];
    
    btCancel = [UIButton buttonWithType:UIButtonTypeCustom];
    [btCancel setBackgroundImage:[UIImage imageNamed:@"life_3_03"] forState:UIControlStateNormal];
...
//    shareView = [[UIView alloc]init];
    ...
    [btShare1 setBackgroundImage:[UIImage imageNamed:@"add"] forState:UIControlStateNormal];
    btShare1.frame = CGRectMake(50, 0, 139, 41);
    [shareView addSubview:btShare1];
    UIButton *btShare2 = [UIButton buttonWithType:UIButtonTypeCustom];
    [btShare2 setBackgroundImage:[UIImage imageNamed:@"share"] forState:UIControlStateNormal];
    btShare2.frame = CGRectMake(50, 50, 138, 41);
    [shareView addSubview:btShare2];
    UIButton *btShare3 = [UIButton buttonWithType:UIButtonTypeCustom];
    [btShare3 setBackgroundImage:[UIImage imageNamed:@"share_w"] forState:UIControlStateNormal];
    btShare3.frame = CGRectMake(50, 150, 184, 41);
    [shareView addSubview:btShare3];

    btPlus = [UIButton buttonWithType:UIButtonTypeCustom];
    [btPlus setBackgroundImage:[UIImage imageNamed:@"life_two_03"] forState:UIControlStateNormal];
    ...
    [bt5 setBackgroundImage:[UIImage imageNamed:@"little_02"] forState:UIControlStateNormal];
    ...
    [bt6 setBackgroundImage:[UIImage imageNamed:@"little_03"] forState:UIControlStateNormal];
    ...
    [bt7 setBackgroundImage:[UIImage imageNamed:@"little_04"] forState:UIControlStateNormal];
    ...
    [bt8 setBackgroundImage:[UIImage imageNamed:@"little_05"] forState:UIControlStateNormal];
...
- (void)click
{
    ...
    [UIView setAnimationCurve:UIViewAnimationCurveEaseInOut];
    [UIView setAnimationDuration:0.3];
    btCancel.frame = CGRectMake(0, 44+50, 36, 36);
    btPlus.frame = CGRectMake(1024-45, 44+50, 45, 45);
