...
//        self.tabBarItem.image = [UIImage imageNamed:@"life000_03.png"];
        [self.tabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"life000_03.png"] withFinishedUnselectedImage:[UIImage imageNamed:@"life000_03.png"]];
...
//        m_scrollView.backgroundColor = [UIColor redColor];
        ...
        for (int i = 0; i < 2; i++) {
            ...
            [bt1 setBackgroundImage:[UIImage imageNamed:@"life__04"] forState:UIControlStateNormal];
            bt1.frame = CGRectMake(0+1024*i, 0, 256, 210);
            ...
            [bt2 setBackgroundImage:[UIImage imageNamed:@"life__07"] forState:UIControlStateNormal];
            bt2.frame = CGRectMake(256+1024*i, 0, 256, 210);
            ...
            [bt3 setBackgroundImage:[UIImage imageNamed:@"life__10"] forState:UIControlStateNormal];
            bt3.frame = CGRectMake(512+1024*i, 0, 256, 210);
            ...
            [bt4 setBackgroundImage:[UIImage imageNamed:@"life__12"] forState:UIControlStateNormal];
            bt4.frame = CGRectMake(768+1024*i, 0, 256, 210);
...
//        [self.view addSubview:bt];
        ...
        UIImageView *img1 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"5.png"]];
...
- (void)switchFocusImageItems
{
    ...
    [self performSelector:@selector(switchFocusImageItems) withObject:nil afterDelay:1];
}
